...
export default function AladesignPreloader() {
  ...
  useGSAP(
    () => {
      ...
      let heroImgWidth: number | string;
      let heroImgHeight: number | string;
      if (heroImg) {
        heroImgWidth = heroImg.offsetWidth;
        heroImgHeight = heroImg.offsetHeight;
      } else {
        heroImgWidth =
          window.innerWidth < 551
            ? "88vw"
